...
class Digest:
    """ Handles protein digestion and macromolecular analysis tasks. """
    ...
    def find_virus_parts(input_fasta, target_root):
        ...
        return f"Succesfully processed {len(real_proteins)} protein fragments. Output directory: {output_dir}"